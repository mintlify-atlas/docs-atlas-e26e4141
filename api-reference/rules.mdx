...
sidebarTitle: "Rules"
description: "Reference for the two rules endpoints on a link: GET to read routing rules and PUT to replace them atomically with platform or query-param conditions."
---
