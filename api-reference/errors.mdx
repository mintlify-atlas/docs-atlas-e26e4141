...
sidebarTitle: "Errors"
description: "The JSON error envelope linq returns on every failure path, all HTTP status codes, Zod validation error details, and common causes for each response code."
---
